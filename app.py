...
=======
>>>>>>> 2488b5c3d6736afcda4e16e4b4b4e7547d35b067
...
<<<<<<< HEAD
    ...
    return render_template('bookings.html', bookings=all_bookings, customers=all_customers, rooms=all_rooms)
...
<<<<<<< HEAD
    ...
    # Update room status to "Available" if it's not reused
